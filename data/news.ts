...
export const newsArticles: NewsArticle[] = [
  {
    ...
    year: 2026,
    title:
      "[공감신문] 데이터메티카, '자율주행 실증도시 운영방안' 사업 수주…전남광주통합특별시 실증 연계",
    description:
      "AI·데이터 전문기업 데이터메티카가 한국교통안전공단 자동차안전연구원이 발주한 '자율주행 실증도시 운영방안' 연구 사업을 수주했다. 실제 도심 환경에서 자율주행 기술과 서비스의 상용화 가능성을 검증할 수 있는 실증도시의 체계적인 운영 프레임워크를 마련하는 사업으로, 전남광주통합특별시가 추진하는 자율주행 실증도시 구축 계획과 연계된다. 그동안 AI 학습용 데이터셋 구축과 자율주행 센서·주행 데이터 사업을 수행해 온 데이터메티카는 이번 수주를 계기로 도시 단위 인프라의 정책·운영 전략 수립 영역으로 사업을 확장할 계획이다.",
    source: "https://www.gokorea.kr/news/articleView.html?idxno=878024",
    thumbnail: "/news/2026/26091102.avif",
  },
  {
    id: "26091101",
    date: "2026년 9월 11일",
