...
export default function MainPage({
  ...
  return (
    <div className="relative w-full bg-[#F6F7F9]">
      ...
      >
        <div className="absolute top-0 left-0 translate-x-full translate-y-[30%] [writing-mode:vertical-rl] rotate-180 text-[#f9eaeb] text-[64px] md:text-[128px] font-black leading-none">
          Datamatica
        </div>
      </div>
